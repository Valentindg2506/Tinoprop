<?php
/*
 * Archivo: cambiar-password.php — V0.0.30 Pre-Producción
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nueva === '' || $repetir === '') {
        ...
        $mensaje = 'La contraseña debe tener 8-16 caracteres, al menos 1 mayúscula y 1 símbolo.';
        $mensaje_tipo = 'error';
    ...
    <div class="container login-solo" id="container">
        <div class="form-container sign-in-container" style="width:100%;">
            <form method="POST" action="cambiar-password.php">
                ...
                <p class="login-ayuda">
                    Requisitos: 8-16 caracteres, al menos 1 mayúscula y 1 símbolo.
                </p>
            </form>
        </div>
    </div>
