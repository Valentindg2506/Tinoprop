...
if (isset($_GET['exportar']) && $_GET['exportar'] === 'csv') {
    ...
    $stmt = $pdo->prepare('SELECT v.*, p.titulo AS propiedad, c.nombre AS cliente_nombre, c.apellido AS cliente_apellido FROM visitas v LEFT JOIN propiedades p ON v.propiedad_id = p.id LEFT JOIN clientes c ON v.cliente_id = c.id WHERE v.usuario_id = :uid AND v.equipo = "vendedor" ORDER BY v.id DESC');
