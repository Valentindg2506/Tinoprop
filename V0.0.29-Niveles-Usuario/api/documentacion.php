...
if ($action && in_array($action, $acciones_escritura_doc) && !csrf_verify_api()) {
    doc_json_response(403, ['success' => false, 'error' => 'Token CSRF inválido']);
}
...
try {
    ...
    doc_json_response(500, ['success' => false, 'message' => 'Error interno: ' . $e->getMessage()]);
}
