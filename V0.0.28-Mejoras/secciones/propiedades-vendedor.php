...
if (isset($_GET['exportar']) && $_GET['exportar'] === 'csv') {
    $stmt = $pdo->prepare('SELECT titulo, operacion, precio, moneda, ubicacion, referencia, estado, created_at FROM propiedades WHERE equipo = :eq ORDER BY id DESC');
    $stmt->execute(['eq' => 'vendedor']);
