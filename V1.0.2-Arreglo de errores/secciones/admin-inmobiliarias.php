            ...
            <tbody>
                ...
                <tr class="<?php echo empty($inmob['activa']) ? 'fila_inactiva' : ''; ?>">
                    ...
                    <td class="acciones_celda">
                        ...
                        <form method="POST" style="display:inline" onsubmit="return confirm('⚠️ ATENCIÓN: Vas a eliminar la inmobiliaria ' + <?php echo json_encode($inmob['nombre']); ?> + ' y TODOS sus datos (usuarios, clientes, propiedades, visitas, ofertas, etc.).\n\nEsta acción es IRREVERSIBLE.\n\n¿Estás seguro?');">
                            <?php echo csrf_field(); ?>
