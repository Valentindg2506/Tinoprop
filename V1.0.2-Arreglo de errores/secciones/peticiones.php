<?php
/*
 * Sección: Peticiones (Jefe → SuperAdmin)
 * Rol: permite a los Jefes de inmobiliarias enviar reportes de errores,
 *      solicitudes de mejora y consultas al administrador del sistema.
 */
...
// Secciones disponibles para reportar
$secciones_app = [
    '' => '— Seleccionar sección —',
    'dashboard' => 'Dashboard',
    'clientes' => 'Clientes',
