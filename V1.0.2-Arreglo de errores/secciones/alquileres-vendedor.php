...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['crear_alquiler'])) {
        ...
        actividad_registrar($pdo, 'crear', 'propiedad', (int) $pdo->lastInsertId(), $titulo);
        flash_set('success', 'Alquiler creado correctamente.');
    }

    if (isset($_POST['eliminar_propiedad'])) {
        // Elimina notas asociadas y luego la propiedad en alquiler (transacción para consistencia).
