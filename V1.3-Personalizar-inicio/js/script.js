...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inicializarOrdenDashboard = (selectorContenedor, selectorItems, storageKey, estaEditando) => {
    ...
    actualizarModoDashboard();
    inicializarOrdenDashboard('.dashboard_kpis', '.kpi_card[data-dashboard-card]', 'tinoprop.dashboard.kpis.order', estaEditandoDashboard);
    inicializarOrdenDashboard('.dashboard_grid', '.panel_panel[data-dashboard-card]', 'tinoprop.dashboard.panels.order', estaEditandoDashboard);
});
