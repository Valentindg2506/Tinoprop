...
// Controlador POST del módulo: alta y baja de clientes comprador.
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['crear_cliente'])) {
        ...
        // Inserta cliente del tipo comprador.
        $stmt = $pdo->prepare(
...
// Listado principal de clientes comprador para renderizado de tabla.
