	...
	<div class="contenedor_principal">
		...
		<div class="grupo_menu">
			...
			<ul>
				...
				<li>
					<a href="?seccion=#">Proceso</a>
					<span class="btn_star" onclick="toggle_favorito('Proceso')">☆</span>
				</li>
				<li>
					<a href="?seccion=#">Visitas</a>
					<span class="btn_star" onclick="toggle_favorito('Visitas')">☆</span>
				</li>
			</ul>
		</div>
